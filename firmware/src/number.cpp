...
void Number::printfW1830(int numx,int numy,int numn)
{
 ...
 void Number::printfDot1260(int numx,int numy)
 {
   TJpgDec.drawJpg(numx,numy,W_1260_Dot, sizeof(W_1260_Dot));
 }

 void Number::printfDotRev1260(int numx,int numy)
 {
  TJpgDec.drawJpg(numx,numy,W_1260_Dot_Rev, sizeof(W_1260_Dot_Rev));
 }
